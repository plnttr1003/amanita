...
exports.add_form = function(req, res) {
	...
	locales.forEach(function(locale) {
		...
		checkNested(post, [locale, 'additional_title'])
			&& news.setPropertyLocalised('additional_title', post[locale].additional_title, locale);

		checkNested(post, [locale, 'link'])
			&& news.setPropertyLocalised('link', post[locale].link, locale);
